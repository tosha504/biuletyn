...
function realestate_setup() {
	...
	register_nav_menus(
		array(
			'header_left' => esc_html__( 'Lewa część meni', 'realestate' ),
			'header_right' => esc_html__( 'Prawa część meni', 'realestate' ),
			'mobile' => esc_html__( 'Meni na telefon', 'realestate' ),
		)
	);
...
add_image_size_new( 'gallery-full', 1200, 800, false );
